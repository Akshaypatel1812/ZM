...
const RespiratoryProtection = () => {
  const product = {
    ...
    images: [
      {
        id: 1,
        src: "https://5.imimg.com/data5/DX/NT/WO/SELLER-5371069/v-500-single-filter-half-mask-respirator-500x500.jpg",
        name: "GAS MAS HALF CARTRIDGE V500+V7500",
      },
      {
        id: 2,
        src: "https://5.imimg.com/data5/SELLER/Default/2022/9/FC/BK/VV/4613071/gas-protection-full-mask-500x500.jpg",
        name: "Single Cartage multi gas mask",
      },
      {
        id: 3,
        src: "https://5.imimg.com/data5/SELLER/Default/2021/11/OP/YH/AT/901356/double-cartridge-gas-masks.jpg",
        name: "DOUBLE CARTAGE MULTI GAS MASK",
      },
