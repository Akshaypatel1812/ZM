...
const SafetyHelmet = () => {
  const product = {
    ...
    images: [
      {
        id: 1,
        src: "https://5.imimg.com/data5/SELLER/Default/2023/11/364032154/MW/WB/PX/4208313/karam-pn-542-safety-helmet.jpg",
        name: "Karam Safety Helmet",
      },
      {
        id: 2,
        src: "https://m.media-amazon.com/images/I/31EzI8gItJL._SR600%2C315_PIWhiteStrip%2CBottomLeft%2C0%2C35_SCLZZZZZZZ_FMpng_BG255%2C255%2C255.jpg",
        name: "Karam Safety Helmet With Tourch",
      },
