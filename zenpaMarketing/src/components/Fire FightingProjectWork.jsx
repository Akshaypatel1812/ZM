...
const FireFightingProjectWork = () => {
  const product = {
    ...
    images: [
      {
        id: 1,
        src: "https://5.imimg.com/data5/SELLER/Default/2022/11/SX/NW/XD/6993701/firefighter-pipeline-work.jpg",
        name: "Hole FireFighting Project Work",
      },
...
export default FireFightingProjectWork;
