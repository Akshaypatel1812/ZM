...
const CCTVCameras = () => {
  const product = {
    ...
    images: [
      {
        id: 1,
        src: "https://5.imimg.com/data5/MI/BV/FR/SELLER-15970536/ip-cameras-500x500.jpg",
        name: "HIKVISION",
      },
      {
        id: 2,
        src: "https://5.imimg.com/data5/GG/FU/WM/SELLER-81704719/dahua.png",
        name: "DAHUA",
      },
      {
        id: 3,
        src: "https://5.imimg.com/data5/RL/JZ/TS/SELLER-11188381/cp-plus-cctv-security-system.jpg",
        name: "CP PLUS",
      },
      {
        id: 4,
        src: "https://cdn.staticans.com/image/tr:e-sharpen-01,h-1000,w-1000,cm-pad_resize/data/philips/10-apr-2023/HSP1000_1.jpg",
        name: "PHILIPS",
      },
