...
const EyeProtection = () => {
  const product = {
    ...
    images: [
      {
        id: 1,
        src: "https://5.imimg.com/data5/SELLER/Default/2022/1/UO/JP/GD/1311973/3m-1611-over-spectacles-goggles.png",
        name: "3M Over Spect",
      },
      {
        id: 2,
        src: "https://m.media-amazon.com/images/I/61P2F032FZL.jpg",
        name: "3M Poly Carbonet Googels",
      },
      {
        id: 3,
        src: "https://rukminim2.flixcart.com/image/850/1000/ktizdzk0/safety-goggle/j/e/t/free-size-2-3m-11850-virtua-in-1-pcs-clear-safety-goggles-black-original-imaf373bq5rmm2kv.jpeg?q=20&crop=false",
        name: "3M 11850 Virtua",
      },
