...
const FireExtinguisher = () => {
    const product = {
        name: "Sample Product",
        description: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eius incidunt tempore laudantium aperiam ducimus necessitatibus accusantium, nulla at quam labore dolor minus, aliquid reprehenderit! Eaque impedit velit, aliquam dolor eius non perspiciatis?.",
        price: 29.99,
        images: [
          {
            id: 1,
